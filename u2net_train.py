...
@click.option("--img_dir", default="/content/U-2-Net/data/MSRA-Segment/train")
@click.option("--retrain", default=False, type=bool)
@click.option("--weight", default="/content/U-2-Net/saved_models")
@click.option("--model_dir", default="./saved_model")
